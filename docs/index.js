(() => {
  ...
  function onShowResults() {
    ...
    const payload = {
      ...
      vendorUrl,
      vendorName: vendor === "baker" ? "BAKER TARGETS" : "",
      surveyUrl: "",
      target: { key: targetSizeKey, wIn: Number(targetWIn), hIn: Number(targetHIn) },
      distance_yards: getDistanceYds(),
      windage_clicks: Number(out.windage.clicks.toFixed(2)),
      windage_dir: out.windage.dir,
      elevation_clicks: Number(out.elevation.clicks.toFixed(2)),
      elevation_dir: out.elevation.dir,
      debug: {
        aim,
        hits,
        avgPoi: out.avgPoi,
