/* ============================================================
   ...
   Includes:
   - MOMA top-right only (IN⇄M, Distance, Click MOA, Update)
   - Session-only metric toggle (resets on Clear + New Upload)
   - Grid detect px/in (1" printed squares)
...
(() => {
  ...
  // ----- Dot styles (LOCKED 10px, filled colored markers)
  ...
  function applyMoma() {
    ...
    session.distanceYds = isMetric ? (distNum * YARDS_PER_METER) : distNum;
